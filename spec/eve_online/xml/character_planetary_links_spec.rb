...
describe EveOnline::XML::CharacterPlanetaryLinks do
  let(:key_id) { 123 }
  ...
  specify { expect(described_class::API_ENDPOINT).to eq('https://api.eveonline.com/char/PlanetaryLinks.xml.aspx') }
