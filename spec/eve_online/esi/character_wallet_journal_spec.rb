...
describe EveOnline::ESI::CharacterWalletJournal do
  ...
  specify { expect(described_class::API_ENDPOINT).to eq('https://esi.evetech.net/v5/characters/%<character_id>s/wallet/journal/?datasource=%<datasource>s&page=%<page>s') }
