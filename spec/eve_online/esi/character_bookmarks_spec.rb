...
describe EveOnline::ESI::CharacterBookmarks do
  ...
  specify { expect(described_class::API_ENDPOINT).to eq('https://esi.tech.ccp.is/v2/characters/%<character_id>s/bookmarks/?datasource=tranquility') }
  ...
  # describe '#bookmarks' # TODO: write this
