...
describe "Get contracts" do
  context "when etag not set" do
    ...
    specify { expect(subject.etag).to eq("6e18566a8f786f08aba678262360d0c74a783f9923aa43f8043133e4") }
    ...
    let(:options) do
      {
        ...
        token: "token123",
        page: 1,
        etag: "6e18566a8f786f08aba678262360d0c74a783f9923aa43f8043133e4"
      }
    end

    before { VCR.insert_cassette "esi/character_contracts/1337512245_with_etag" }
